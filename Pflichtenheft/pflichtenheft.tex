...
\newpage
	...
	Neben dem FROST-Server stellt das Fraunhofer auch den FROST-Client bereit, eine Bibliothek, die hilft auf die SensorThings API zuzugreifen\footnote{https://github.com/FraunhoferIOSB/FROST-Client}. \\
	\ \\
...
\newpage
	...
	Die SensorThings API besteht aus folgenden Elementen, die miteinander im Zusammenhang stehen. Jedes Element hat bestimmte Eigenschaften. Diese und die Beziehungen sind im unten abgebildeten UML-Diagramm (\cref{fig:ogc}) dargestellt. \\
	\begin{enumerate}
...
\section{Zielbestimmung}
	...
	\item Auswahl komplexer Transformationen/Aggregationen\\ 
	Aggregationen auf ausgewählten Daten (bspw. Summe oder Durschnitt) werden dem Benutzer bereitgestellt.
