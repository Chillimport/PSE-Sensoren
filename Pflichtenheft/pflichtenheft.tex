...
\end{itemize}
	...
	\teststep{Alle Textfelder ausgefüllt}{Der User klickt auf den Button \string"Upload\string", aber hat fehlerhafte Daten ausgewählt}{Das Programm meldet einen Fehler im Log und bricht die Verarbeitung ab}
