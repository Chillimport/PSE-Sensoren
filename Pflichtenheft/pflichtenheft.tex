...
\makenoidxglossaries
	...
	\newglossaryentry{stApi}{
		name={SensorThings API},description={Allgemeiner einheitlicher Standard um Verbindung zwischen Sensoren, deren Ort und Umgebung und den von ihnen erzeugten Daten herzustellen}
	}
