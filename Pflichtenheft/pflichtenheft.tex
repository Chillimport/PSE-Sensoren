...
\makenoidxglossaries
	...
	\newglossaryentry{ogc}{
		name={OGC},description={Das \textbf{O}pen \textbf{G}eospatial \textbf{C}onsortium ist eine gemeinnützige Organisation, die gegründet wurde, um frei nutzbare, allgemeingültige Standards für die raumbezogene Informationsverarbeitung (insbesondere Geodaten) festzulegen. \\
	...
	\newglossaryentry{int}{
		name={Integer},description={Integer (deutsch: Ganzzahl) ist ein Datentyp zum Speichern ganzzahliger Werte}
	}
	...
	\newglossaryentry{headless}{
		name={headless},description={Als headless (kopflos) bezeichnet man Server/Computer, die über keine grafische Ausgabe, also insbesondere keinen Bildschirm verfügen. Diese Systeme haben als Steuerungsmöglichkeit in vielen Fällen eine Netzwerkverbindung}
	}
...
\section{Zielbestimmung}
	...
	\criteriumOptional{Komplexe Transformation/\glspl{aggr}}{crt:aggr}
