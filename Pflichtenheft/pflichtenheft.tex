...
\begin{document}
	...
	\begin{itemize}
		\item Die Software speichert ein Log-File um Fehlerbehebung zu erleichtern.
		\item Die Programmkonfiguration kann Serverseitig gespeichert und heruntergeladen werden.
		\item Die Zieladresse (FROST-Server) wird einmalig konfiguriert und Serverseitig gespeichert. Sie kann danach wieder geändert werden.
	\end{itemize}
